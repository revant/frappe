...
def validate_auth():
    ...
    if len(authorization_header) == 1:
        frappe.throw(
            _(
                "Invalid Authorization headers, add a token with a prefix from one of the following: {0}."
...
def validate_oauth(authorization_header):
    ...
    try:
        ...
        frappe.throw(
            _(
                "Invalid Bearer token, please provide a valid access token with prefix 'Bearer'."
            ),
...
def validate_auth_via_api_keys(authorization_header):
    ...
    try:
        ...
        frappe.throw(
            _(
                "Invalid token, please provide a valid token with prefix 'Basic' or 'Token'."
            ),
            frappe.InvalidAuthorizationToken,
        )
