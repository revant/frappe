...
class TestEmailAccount(unittest.TestCase):
    ...
    def test_incoming(self):
        ...
        with open(
            os.path.join(os.path.dirname(__file__), "test_mails", "incoming-1.raw"), "r"
        ) as f:
            test_mails = [f.read()]
    ...
    def test_incoming_attached_email_from_outlook_plain_text_only(self):
        ...
        with open(
            os.path.join(os.path.dirname(__file__), "test_mails", "incoming-3.raw"), "r"
        ) as f:
            test_mails = [f.read()]
    ...
    def test_incoming_attached_email_from_outlook_layers(self):
        ...
        with open(
            os.path.join(os.path.dirname(__file__), "test_mails", "incoming-4.raw"), "r"
        ) as f:
            test_mails = [f.read()]
