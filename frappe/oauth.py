    ...
    def __init__(
        ...
        **kwargs
        ...
        resource_owner_password_credentials_grant = (
            ResourceOwnerPasswordCredentialsGrant(request_validator)
        )
        bearer = BearerToken(
            request_validator,
            token_generator,
        ...
        AuthorizationEndpoint.__init__(
            ...
            response_types={"code": auth_grant, "token": implicit_grant},
...
class OAuthWebRequestValidator(RequestValidator):
    ...
    def authenticate_client(self, request, *args, **kwargs):
        ...
        try:
            ...
            print(
                "Failed body authentication: Application %s does not exist".format(
    ...
    def validate_user_match(self, id_token_hint, scopes, claims, request):
        ...
        Method is used by:
            ...
            - OpenIDConnectHybrid
        """
        if id_token_hint and id_token_hint == frappe.db.get_value(
            "User Social Login",
